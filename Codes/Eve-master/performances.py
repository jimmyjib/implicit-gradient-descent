...
plt.plot(ttime, trainS, color="orange", linewidth=1.0, linestyle="-", label="SGD")
...
plt.plot(ttime, trainI, color = "red", linewidth=1.7, linestyle="-", label="IGD")
...
plt.plot(ttime, testS, color="orange", linewidth=1.0, linestyle="-", label="SGD")
...
plt.plot(ttime, testI, color="red", linewidth=1.7, linestyle="-", label="IGD")
